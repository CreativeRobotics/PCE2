...
class userObject 
{
  ...
  void display(int yPos) {
    ...
    drawRectWrap(environmentStartX+playerPosition, yPos, playerWidth, userHeight);
    //draw the lure
    fill(color(hue, 150, lBrightness));
    drawRectWrap(environmentStartX+lurePosition, yPos, lureWidth, userHeight);
    //stroke(userCol);
    drawLineWrap(environmentStartX+playerPosition+playerWidth, lureOffset, yPos+(userHeight/2));
    //line(environmentStartX+playerPosition+playerWidth, yPos+(userHeight/2), environmentStartX+lurePosition, yPos+(userHeight/2));
  }
  //-----------------------------------------------------------------------
